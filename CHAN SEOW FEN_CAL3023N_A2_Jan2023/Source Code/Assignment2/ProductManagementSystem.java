...
import java.util.Collections; // For copy arraylist
            ...
            case 1 :  //(1) Display According to Manufacturing Country
                ...
                switch(countrySelection)
                {
                    case 1: //(1) Malaysia
                    	...
                    	while(Index1>=0) //loop until no result as binary search can only return one result one time
                    	{
                    ...
                    case 2: //(2) Japan
                    	ArrayList<Product> productsClone2 = new ArrayList<>(products); // declare clone array for binary search
                    	Collections.copy(productsClone2,products); //copy product array to a clone for binary search
                    	ArrayList<Product> productsDisplay2 = new ArrayList<>();
                    	validSelection2 = true;
                    	int Index2 = 0;
                    	Product targetProduct2 = new Product("", "Japan", "", "", "", 0);
                    	while(Index2>=0) //loop until no result as binary search can only return one result one time
                    	{
                    	// Binary search for the first occurrence of the target product
                    	if(!productsClone2.isEmpty())
                    	{
                    	Index2 = Collections.binarySearch(productsClone2, targetProduct2, new Comparator<Product>() 
                    	{
                    	    public int compare(Product p1, Product p2) 
                    	    {
                    	        return p1.getCountry().compareTo(p2.getCountry());
                    	...
                    	Index2=-1;
                    	if(Index2>=0) //if entry found, add the entry to the display array and remove from clone array
                    	{
                    ...
                    case 3: //(3) America
                    	...
                    	while(Index3>=0) //loop until no result as binary search can only return one result one time
                    	{
                    	// Binary search for the first occurrence of the target product
                    	if(!productsClone3.isEmpty())
                    	{
                    	Index3 = Collections.binarySearch(productsClone3, targetProduct3, new Comparator<Product>() 
                    	{
                    	    public int compare(Product p1, Product p2) 
                    	    {
                    	        return p1.getCountry().compareTo(p2.getCountry());
                    	...
                    	Index3=-1;
                    	if(Index3>=0) //if entry found, add the entry to the display array and remove from clone array
                    	{
